...
static safety_config byd_init(uint16_t param) {
  ...
  static RxCheck byd_rx_checks[] = {
    ...
    {.msg = {{0x1F0, 0, 8,  50U, .ignore_counter = true, .ignore_quality_flag = true}, { 0 }, { 0 }}},                          // WHEELSPEED_CLEAN
    {.msg = {{0x242, 0, 8,  50U, .ignore_checksum = true, .ignore_counter = true, .ignore_quality_flag = true}, { 0 }, { 0 }}},  // DRIVE_STATE (no checksum)
    {.msg = {{0x32D, 2, 8,  50U, .ignore_counter = true, .ignore_quality_flag = true}, { 0 }, { 0 }}},                          // ACC_HUD_ADAS
  };
